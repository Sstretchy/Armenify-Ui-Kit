...
const ghostButtonVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      size: {
        info: "size-[var(--space-space-5)] text-font-size-xs leading-[var(--font-font-height-xs)]",
        xxxs: "size-[var(--space-space-6)] text-font-size-xs leading-[var(--font-font-height-xs)]",
        xxs: "size-[var(--space-space-7)] text-font-size-sm leading-[var(--font-font-height-sm)]",
