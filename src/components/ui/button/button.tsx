...
export type ButtonAsButtonProps = SharedButtonLayoutProps &
  Omit<React.ComponentPropsWithoutRef<"button">, keyof SharedButtonLayoutProps | "href"> & {
    href?: undefined;
  };

export type ButtonAsAnchorProps = SharedButtonLayoutProps &
  Omit<React.ComponentPropsWithoutRef<"a">, keyof SharedButtonLayoutProps | "href"> & {
    href: string;
  };
...
function Button(props: ButtonProps) {
  if (isButtonLinkProps(props)) {
    ...
    const common = {
      ...
      "data-button-pressed": Boolean(pressed) && !disabled ? ("" as const) : undefined,
