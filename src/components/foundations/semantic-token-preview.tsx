...
const neutralBgSection: SwatchSection = {
  ...
  items: [
    ...
    { value: "var(--semantic-bg-ntrl-tertiary-inverse-active)", label: "tertiaty-inverse-active", hint: "600" },
    { value: "var(--semantic-bg-ntrl-tertiary-inverse-pressed)", label: "tertiaty-inverse-pressed", hint: "500" },
    ...
    { value: "var(--semantic-bg-ntrl-tertiary-active)", label: "tertiaty-active", hint: "200" },
    { value: "var(--semantic-bg-ntrl-tertiary-pressed)", label: "tertiaty-pressed", hint: "250" },
...
const brandBgSection: SwatchSection = {
  ...
  items: [
    ...
    { value: "var(--semantic-bg-brand-primary-inverse-pressed)", label: "tertiary-inverse-pressed", hint: "700" },
    ...
    { value: "var(--semantic-bg-brand-tertiary-inverse-active)", label: "tertiaty-inverse-active", hint: "600" },
    { value: "var(--semantic-bg-brand-tertiary-inverse-pressed)", label: "tertiaty-inverse-pressed", hint: "500" },
    ...
    { value: "var(--semantic-bg-brand-tertiary-active)", label: "tertiaty-active", hint: "200" },
    { value: "var(--semantic-bg-brand-tertiary-pressed)", label: "tertiaty-pressed", hint: "250" },
...
const brandBorderSection: SwatchSection = {
  ...
  items: [
    ...
    { value: "var(--semantic-border-brand-default-inversed)", label: "default-inversed", hint: "700" },
